    ...
    <div class="contant" style="padding-left: 1%;padding-right: 1.5%;;padding-top: 1.5%;">
        <div class="container-fluid">
            <section class="services">
                ...
                <div class="s-heading">
                    <h1 style="color:#023f71; font-size:24px"> التدريب التعاوني</h1>
                </div>
                <div>

                    <strong>
                        <h1 style="color:black; text-align:center;">
                            عزيزتي المتدربة لخدمتك بشكل اسرع يرجى الانضمام لقناة التدريب التعاوني للكلية التقنية الرقمية
                            بالأحساء
                        </h1>
                    </strong>
                    <br>
                    <img src="../images/arra.gif" alt="الباركود" width="160px"
                        style="margin-top:-9px;margin-right: 25px; text-align:center ;  margin:auto; display:block;" />
                    </td>

                    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                        style="max-width: 100%;height: auto; margin:auto; display:block;" width="180px" height="180px"
                        viewBox="0 0 999 999">
                        <defs>
                            <mask id="qrmask">
                                <g fill="#ffffff">
                                    <g>
                                        ...
                                        <g transform="translate(459,54) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(297,135) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(594,270) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        <g transform="translate(621,270) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(270,297) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(702,297) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(675,324) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(675,432) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(783,459) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(756,486) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        <g transform="translate(837,486) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(54,540) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(378,540) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        <g transform="translate(459,540) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        <g transform="translate(513,540) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(432,567) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(297,621) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(189,648) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(486,648) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(621,702) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(891,729) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(675,810) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(621,837) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                                        ...
                                        <g transform="translate(702,891) scale(4.635)">
                                            <rect width="6" height="6"></rect>
                                        </g>
                        ...
                        <rect x="0" y="0" width="999" height="999" mask="url(#qrmask)" fill="#000000"></rect>
                        <g>
